...
function AchexWs(obj) 
{
    ...
    this.callback =(typeof( obj.callback ) === 'function') ? obj.callback : function(){console.log('')};
    this.opencallback = (typeof(obj.opencallback) === 'function') ? obj.opencallback : function(){console.log('')};
    this.closecallback = (typeof(obj.closecallback) === 'function') ? obj.closecallback: function(){console.log('')};
